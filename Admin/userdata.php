...
if(isset($_POST['submitDeleteBtn'])){
    ...
    $check=mysqli_query($connection,"select * from user where username='$key'") or die("not found".mysqli_error($connection));
    if(mysqli_num_rows($check)>0){
        mysqli_query($connection,"delete from user where username='$key'");
    }
    else{
       echo "Not found";
    }
